    ...
    <div className="creating lg:pt-52  pt-32 pb-14 relative px-3 lg:px-0">
      ...
      <div className="container max-w-[1360px] mx-auto">
        <div className=" flex flex-wrap justify-between  items-center">
          ...
          >
            <img
              className=" w-[100%] md:w-[70%] xl:w-[100%] cursor-pointer"
              src={secsevncard}
              alt="img"
            />
          </div>
          <div className=" lg:w-[33%] w-full " data-aos="fade-down">
          ...
          >
            <img
              className=" xl:translate-y-[-25%] mt-9 lg:mt-0  w-[100%] md:w-[70%] xl:w-[100%] cursor-pointer"
              src={yello}
              alt="img"
            />
          </div>
